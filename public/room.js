...
function updateLayout() {
  let count = Object.keys(remoteVideos).length + 1;
  participants.className = "";

  if (count === 1) participants.classList.add("one");
  if (count === 2) participants.classList.add("two");
  if (count === 3) participants.classList.add("three");
  if (count >= 4) participants.classList.add("four");
}
